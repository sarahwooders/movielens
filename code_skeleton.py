...
def SV_thresholding_hard(data_train, data_test, tau_h=2):
    print('here')
    Y_prime = get_rating_matrix(data_train, 6041, 3953)# TODO
    print("starting svd")
...
def SVD(Y):
    ...
    # compute SV decomposition of a matrix Y
...
if __name__ == '__main__':
    ...
    SV_thresholding_hard(data_train, data_test)
